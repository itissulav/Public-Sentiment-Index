...
- [id](file:///s:/FYP/Public%20Sentiment%20Index/app/models/topic.py#37-39) (UUID, PK)
...
- **Hero Topic Cards**: The 5 pre-defined topics will be massive, beautifully styled "Dashboard entry" cards. These cards will feature dynamic background images sourced directly from the `app/static/images/` directory.
...
2. Re-run `seed_topics.py` to populate DB with 10,000 (5 x 2000) data points.
